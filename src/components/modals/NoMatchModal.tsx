...
export function NoMatchModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gradient-to-b from-black/90 via-warning/20 to-black/90 backdrop-blur-sm">
      <div className="w-full max-w-sm mx-4 flex flex-col items-center gap-5 animate-in fade-in zoom-in duration-300">
        {/* No Match Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-warning/20 border border-warning rounded-full">
          <span className="w-2 h-2 rounded-full bg-warning animate-pulse" />
          <span className="text-warning text-sm font-semibold uppercase tracking-wide">
            No Match
          </span>
        </div>
        ...
        <p className="text-white/70 text-sm text-center">
          No cards in your hand match the revealed card
        </p>
        ...
        <div className="relative">
          ...
          {/* X Mark Badge */}
          <div className="absolute -top-2 -right-2 w-10 h-10 bg-warning rounded-full flex items-center justify-center shadow-lg">
